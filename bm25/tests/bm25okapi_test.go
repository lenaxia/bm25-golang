...
func TestNewBM25Okapi(t *testing.T) {
    ...
    _, err := bm25.NewBM25Okapi(corpus, tokenizer, -1.0, 0.75, nil)
    if err == nil {
    ...
    _, err = bm25.NewBM25Okapi(corpus, tokenizer, 1.2, 1.5, nil)
    if err == nil {
    ...
    _, err = bm25.NewBM25Okapi(corpus, tokenizer, 1.2, 0.75, nil)
    if err != nil {
